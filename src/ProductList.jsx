...
function ProductList({ onHomeClick }) {
    ...
    return (
        <div className=''>
            ...
            {!showCart ? (
                <div >
                    {plantsArray.map((plantsArray,index)=>
                        <div className="product-grid" key={index} >
                            
                                <h3 className="plant_heading" style={{ textAlign: 'center' }}>{plantsArray.category}</h3>
                            
                            <ul className='product-list' >
                                {plantsArray.plants.map((plant,i)=>
                                    <div key={i} className="product-card">
                                        <h4 className='plantname_heading'>{plant.name}</h4>
